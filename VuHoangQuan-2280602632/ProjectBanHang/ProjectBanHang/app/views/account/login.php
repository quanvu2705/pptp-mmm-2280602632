            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        <form action="/pptp-mmm-2280602632\VuHoangQuan-2280602632\ProjectBanHang\ProjectBanHang/account/checklogin" method="post">
                            ...
                            <div>
                                ...
                                /pptp-mmm-2280602632\VuHoangQuan-2280602632\ProjectBanHang\ProjectBanHang/account/register " class="text-white-50 fw-bold">Sign Up</a>
                                </p>
                            </div>
                        </form>
                    </div>
